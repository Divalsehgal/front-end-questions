...
1. Object.setPrototypeOf (works, but mutates an existing object's prototype and is one of the slowest JS operations - avoid in hot paths)
2. __proto__ (not recommended, legacy/non-standard-feeling API, same slowness issue)
3. Object.create (best and clean way - sets the prototype at creation time instead of mutating it later)
