...
## 11-12. 🔒 `seal` / ❄️ `freeze` / silent failure

👉 Full explanation (mutability matrix, `preventExtensions`, silent-failure behavior, shallow-freeze gotcha) now lives in `core-language/objects/index.js` — see that file instead of duplicating it here.
